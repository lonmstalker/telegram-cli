...
## [2026-09-19] resolved | P-20260919-003 | QR login показывал ссылку вместо сканируемого кода

- Evidence: owner сообщил о ссылке без кода и незавершённом входе; sanitized status — qr_code/confirm_other_device. TDLib требует сканирование QR из приложения Telegram.
