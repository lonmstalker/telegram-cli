...
| `getCallbackQueryAnswer` | regular_user | `ChatKnown { target: chat_id } AND MessageKnown { target: chat_id, message: message_id }` |
...
| `leaveChat` | regular_user | `ChatKnown { target: chat_id }` |
