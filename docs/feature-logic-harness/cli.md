...
Exit 0 means protocol request success, not terminal completeness. Versioned machine envelope
различает `ok/partial/error`; workflow `complete=false` и event gap не скрываются.
