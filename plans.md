...
|---|---|---|
| P0 | Контракт, repository skeleton и pinned schema | in_progress — Codex / W-20260715-021 |
...
- [ ] Closed typed dispositions для 127 распознанных, но ещё unsupported runtime-signal methods.
